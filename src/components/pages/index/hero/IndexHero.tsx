...
const CARDS: ICard[] = [
    ...
    },
    {
        ...
        id: 1,
        content: 'Чем больше шагов ты\xA0делаешь, тем счастливее твой виртуальный котик! Ленишься\xA0— он\xA0хмурится, идешь к\xA0цели\xA0— мурлычет и\xA0дарит подарки. Хочешь порадовать кота? Вперёд, на\xA0прогулку! 🐾',
        href: '/tamagochi',
    },
    {
        title: 'Услышь наставление усатого\xA0оракула',
        id: 3,
        content: 'Пройди опрос и\xA0узнай своё тотемное фитнес-животное! Йога с плюшевым котиком? Или кроссфит в стиле гепарда? Узнаешь за\xA02\xA0минуты! 😼',
        href: '/your-totem-cat',
    },
];
